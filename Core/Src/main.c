...
static void MX_TIM3_Init(void)
{
  ...
  htim3.Init.CounterMode = TIM_COUNTERMODE_UP;						// TIM3 is used for count timeout between bytes while
  htim3.Init.Period = 143;											// receiving them in UART, so Period = 48 * 3 - 1 = 143 for 3 ms.
